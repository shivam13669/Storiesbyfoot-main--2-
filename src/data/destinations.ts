...
export const destinations: Destination[] = [
  ...
  },
  {
    ...
    name: "Tawang & Bhutan",
    region: "India · Bhutan",
    tagline: "Monasteries, prayer wheels, and alpine valleys",
    summary:
    ...
    packages: [
      {
        ...
        description:
          "Visit Tawang Monastery, cross Sela Pass, and meditate at Paro Taktsang with veteran cultural experts.",
        price: "₹46,700",
        rating: 4.8,
        reviews: 221,
        highlights: [
